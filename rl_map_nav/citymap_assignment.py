...
SHARP_TURN = 12      # FIX ME! Sharp turn angle for tight corners (degrees) - Too small!
...
LR = 0.0005           # FIX ME! Learning rate for neural network optimizer
...
MAX_CONSECUTIVE_CRASHES = 5  # FIX ME! Reset after this many crashes
